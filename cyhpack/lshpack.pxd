...
cdef extern from "lsxpack_header.h" nogil:
    ...
    void lsxpack_header_set_idx(
        lsxpack_header_t* hdr, 
        int hpack_idx, 
        const char* val,
        size_t val_len
    )
    void lsxpack_header_set_qpack_idx(
        lsxpack_header_t* hdr, 
        int qpack_idx, 
        const char* val, 
        size_t val_len
    )
    void lsxpack_header_set_offset(
        lsxpack_header_t* hdr, 
        const char* buf, 
        size_t name_offset, 
        size_t name_len, 
    ...
    void lsxpack_header_set_offset2(
        lsxpack_header_t* hdr, 
        const char* buf, 
        size_t name_offset, 
        size_t name_len, 
    ...
    void lsxpack_header_prepare_decode(
        lsxpack_header_t* hdr, 
        char* out, 
        size_t offset, 
        size_t len
    )
    const char* lsxpack_header_get_name(
        lsxpack_header_t* hdr
    )
    const char* lsxpack_header_get_value(
        lsxpack_header_t* hdr
    )
    size_t lsxpack_header_get_dec_size(
        lsxpack_header_t* hdr
    )
    void lsxpack_header_mark_val_changed(
        lsxpack_header_t* hdr
    )
